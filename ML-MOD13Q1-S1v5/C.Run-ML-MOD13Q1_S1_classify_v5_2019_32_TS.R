...
for (j in 1:length(idkab)){
  ...
  paddy_kab  <- readOGR(paste0('F:/R-Script-DriveF/ML-LS8_S2_S1v1/SHP/paddy_utm/paddy_',region,".shp"),verbose = FALSE)
  ...
  for (k in 1:length(folders_ori)){
    ...
    folder_classify_fmask <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY-MASK/",collapse = "",sep = "")
    dir.create(folder_classify_fmask, showWarnings = FALSE)
    folder_classify_fmask <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY-MASK/",period,"/",collapse = "",sep = "")
    dir.create(folder_classify_fmask, showWarnings = FALSE)
    
    folder_classify_fmask <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY-MASK/",period,"/",model_ML,"/",collapse = "",sep = "")
    dir.create(folder_classify_fmask, showWarnings = FALSE)
    filename_result_classify_fmask <- paste(folder_classify_fmask,region,"_", period, "_MLv5_classify_fmask_",model_ML, sep="")
    filename_tif_classify_fmask <- paste(folder_classify_fmask,region,"_",period,"_MLv5_classify_fmask_",model_ML,".tif", sep="")
    
    
    print(filename_tif_classify_fmask)
    
    folder <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY/",collapse = "",sep = "")
    dir.create(folder, showWarnings = FALSE)
    folder <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY/",period,"",collapse = "",sep = "")
    dir.create(folder, showWarnings = FALSE)
    folder <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY/",period,"/",model_ML,"/",collapse = "",sep = "")
    dir.create(folder, showWarnings = FALSE)
    
    filename_result <- paste(folder,region,"_", period, "_MLv5_classify_",model_ML, sep="")
    filename_tif <- paste(folder,region,"_", period,"_MLv5_classify_",model_ML,".tif", sep="")
    ...
    if (file.exists(filename_tif)==FALSE) {
      ...
      mainDir1 <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/S1_MOD13Q1_ML_v5/svmRadial/",collapse = "",sep = "")
      
      filename <- paste(mainDir1,"WithMasking_LOOCV_S1_MOD13Q1_ML_v5_svmRadial_noProc_0014.rds", sep="")
    ...
    if (file.exists(filename_tif_classify_fmask)==FALSE){
      ...
      raster_classify <- NA
      rast_stack <- NA
      writeRaster(raster_classify_fmask, filename=filename_result_classify_fmask, format="GTiff", overwrite=TRUE)
    ...
    folder_classify_fmask_clear <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY-MASK-CLEAR/",period,"/",collapse = "",sep = "")
    dir.create(folder_classify_fmask_clear, showWarnings = FALSE)
    folder_classify_fmask_clear <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v5/CLASSIFY-MASK-CLEAR/",period,"/",model_ML,"/",collapse = "",sep = "")
    dir.create(folder_classify_fmask_clear, showWarnings = FALSE)
    filename_result_classify_fmask_clear <- paste(folder_classify_fmask_clear,region,"_", period, "_MLv5_classify_fmask_clear_",model_ML, sep="")
    filename_tif_classify_fmask_clear <- paste(folder_classify_fmask_clear,region,"_",period,"_MLv5_classify_fmask_clear_",model_ML,".tif", sep="")
    ...
    if (file.exists(filename_tif_classify_fmask_clear)==FALSE){
      ...
      for (intS2 in -4:4) {
        ...
        folder_clip_paddy <- paste("F:/R-Script-DriveF/ML-LS8_S2_S1v1/CLASSIFY-MASK-PADDY-CLEAR/",period_S2,"/",model_ML_S2,"/",collapse = "",sep = "")
        temp <- paste(folder_clip_paddy,region,"_", period_S2,"_S2_ML_clear_",model_ML_S2,".tif", sep="")
      ...
      writeRaster(raster_classify_fmask_clear, filename=filename_result_classify_fmask_clear, format="GTiff", overwrite=TRUE)
    }
  }
}
