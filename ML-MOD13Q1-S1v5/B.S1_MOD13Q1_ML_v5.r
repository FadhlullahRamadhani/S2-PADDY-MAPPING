...
library(readxl)
S1_MOD13Q1_ML_v5 <- read_excel("C:/MasseyOffice1/Research/R-Script2020/S1_MOD13Q1_ML_v5.xlsx")

S1_MOD13Q1_ML_v5$Phase <- as.factor(S1_MOD13Q1_ML_v5$Phase)
set.seed(7)
# 
# NR <- filter(S1_MOD13Q1_ML_v5, Phase == "1")
# VEG <- filter(S1_MOD13Q1_ML_v5, Phase == "2")
# REPR <- filter(S1_MOD13Q1_ML_v5, Phase == "3")
# RIPE <- filter(S1_MOD13Q1_ML_v5, Phase == "4")
# 
...
# 
# S1_MOD13Q1_ML_v5_sampling_down <- rbind(NR_sample, VEG_sample,REPR_sample,RIPE_sample)
# S1_MOD13Q1_ML_v5_sampling_down <-  S1_MOD13Q1_ML_v5_sampling_down[sample(1:nrow(S1_MOD13Q1_ML_v5_sampling_down)), ]
S1_MOD13Q1_ML_v5_sampling_down <- S1_MOD13Q1_ML_v5
rice_fmask <- S1_MOD13Q1_ML_v5_sampling_down
...
# write.csv(train.data,file="S1_MOD13Q1_ML_v5 train data ML.csv")
# write.csv(test.data,file="S1_MOD13Q1_ML_v5 test data ML.csv")

rice <-S1_MOD13Q1_ML_v5_sampling_down
...
mainDir <- paste("C:/MasseyOffice1/Research/R-Script2020/S1_MOD13Q1_ML_v5/",collapse = "",sep = "")
...
for (model_ML in model_filter) {
  ...
  for(i_formula in 1:length(allModelsList)) {
    ...
    for(i_preName in 1:1) {
      ...
      filename <- paste(name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      ...
      filename_save <- paste(name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,".rds", sep="")
      ...
      if (any(model_varimp == model_ML) ) {
        ...
        filename_varImp <- paste("varImp_",name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,"_all.csv", sep="")
      ...
      filename_rfc_overall <- paste("ConMat_overall_",name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      filename_rfc_table <- paste("ConMat_table_",name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      filename_rfc_class <- paste("ConMat_class_",name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      ...
      if (any(model_varimp == model_ML) ) {
        allModelsResults_varImp <- varImp(allModelsResults)
        allModelsResults_varImp_1 <- allModelsResults_varImp$importance
        filename_varImp <- paste("varImp_",name_fmask,"_",name_data,"_", "S1_MOD13Q1_ML_v5_",model_ML,"_",preName_current_string,".csv", sep="")
        write.csv(allModelsResults_varImp_1, file = filename_varImp)
      }
