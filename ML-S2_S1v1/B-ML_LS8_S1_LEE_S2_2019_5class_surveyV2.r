...
library(readxl)
ML_LS8_S1_LEE_S2_2019_5class_surveyV2 <- read_excel("C:/MasseyOffice1/Research/R-Script2019/ML_LS8_S1_LEE_S2_2019_5class_surveyV2.xlsx")

ML_LS8_S1_LEE_S2_2019_5class_surveyV2$Phase <- as.factor(ML_LS8_S1_LEE_S2_2019_5class_surveyV2$Phase)
set.seed(7)
# 
# NR <- filter(ML_LS8_S1_LEE_S2_2019_5class_surveyV2, Phase == "1")
# VEG <- filter(ML_LS8_S1_LEE_S2_2019_5class_surveyV2, Phase == "2")
# REPR <- filter(ML_LS8_S1_LEE_S2_2019_5class_surveyV2, Phase == "3")
# RIPE <- filter(ML_LS8_S1_LEE_S2_2019_5class_surveyV2, Phase == "4")
# 
...
# 
# ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down <- rbind(NR_sample, VEG_sample,REPR_sample,RIPE_sample)
# ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down <-  ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down[sample(1:nrow(ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down)), ]
ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down <- ML_LS8_S1_LEE_S2_2019_5class_surveyV2
rice_fmask <- ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down
...
# write.csv(train.data,file="ML_LS8_S1_LEE_S2_2019_5class_surveyV2 train data ML.csv")
# write.csv(test.data,file="ML_LS8_S1_LEE_S2_2019_5class_surveyV2 test data ML.csv")

rice <-ML_LS8_S1_LEE_S2_2019_5class_surveyV2_sampling_down
...
mainDir <- paste("C:/MasseyOffice1/Research/R-Script2019/ML_LS8_S1_LEE_S2_2019_5class_surveyV2/",collapse = "",sep = "")
...
for (model_ML in model_filter) {
  ...
  for(i_formula in 1:length(allModelsList)) {
    ...
    for(i_preName in 1:1) {
      ...
      filename <- paste(name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      ...
      filename_save <- paste(name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,".rds", sep="")
      ...
      if (any(model_varimp == model_ML) ) {
        ...
        filename_varImp <- paste("varImp_",name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,"_all.csv", sep="")
      ...
      filename_rfc_overall <- paste("ConMat_overall_",name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      filename_rfc_table <- paste("ConMat_table_",name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      filename_rfc_class <- paste("ConMat_class_",name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,"_",numbering,".csv", sep="")
      ...
      if (any(model_varimp == model_ML) ) {
        allModelsResults_varImp <- varImp(allModelsResults)
        allModelsResults_varImp_1 <- allModelsResults_varImp$importance
        filename_varImp <- paste("varImp_",name_fmask,"_",name_data,"_", "ML_LS8_S1_LEE_S2_2019_5class_surveyV2_",model_ML,"_",preName_current_string,".csv", sep="")
        write.csv(allModelsResults_varImp_1, file = filename_varImp)
      }
