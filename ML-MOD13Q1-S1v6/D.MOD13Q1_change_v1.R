...
for (j in 1:length(idkab)){
  ...
  for (time in time_list) {
    ...
    for (int_classify in 1:length(period_list_classify)){
      ...
      band_folder <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v6/CLASSIFY-MASK-CLEAR/",period_first,"/",model_ML,collapse = "",sep = "")
      ...
      search_str <- paste(region,".*[.]tif$",sep = "")
      band_folder <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v6/CLASSIFY-MASK-CLEAR/",period_prev,"/",model_ML,collapse = "",sep = "")
      if (dir.exists(band_folder)==FALSE){
        next
      }
      setwd(band_folder)
      ...
      folder_clip_paddy <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v6/CLASSIFY-MASK-CLEAR-CD",collapse = "",sep = "")
      ...
      folder_clip_paddy <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v6/CLASSIFY-MASK-CLEAR-CD/CLASSIFY-MASK-CLEAR-CD-",time,"/",period,"/",collapse = "",sep = "")
      dir.create(folder_clip_paddy, showWarnings = FALSE)
      
      folder_clip_paddy <- paste("F:/R-Script-DriveF/ML-MOD13Q1-S1v6/CLASSIFY-MASK-CLEAR-CD/CLASSIFY-MASK-CLEAR-CD-",time,"/",period,"/",model_ML,"/",collapse = "",sep = "")
      dir.create(folder_clip_paddy, showWarnings = FALSE)
